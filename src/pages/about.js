    ...
    <div className=''>
      <div className=' md:flex justify-between items-center gap-5 py-10 mr-[4.166%] ml-[4.166%] md:mr-[0] lg:ml-[10%]'>
        <div className='flex flex-col gap-5 md:w-1/2'>
          ...
          <p className='text-lg '>Welcome to Ecommerce App, where convenience meets quality in the digital marketplace. As your premier destination for all things retail, we pride ourselves on providing an unparalleled shopping experience that caters to your every need.<br /> <br />

          Browse with confidence knowing that each product on Ecommerce App undergoes stringent quality checks and comes from trusted brands and sellers. Enjoy peace of mind with secure payment options and swift, hassle-free delivery to your doorstep.</p>
        </div>
      ...
      <div className='w-11/12 md:w-4/5 m-auto grid grid-cols-2 lg:grid-cols-4 justify-between gap-4 py-6'>
        <div className='w-full text-center border p-6 flex flex-col gap-3 bg-pink-600 border-pink-600 text-white rounded-md' >
      ...
      <div className='w-11/12 lg:w-4/5 m-auto py-10 flex flex-col gap-6 md:grid md:grid-cols-2 lg:grid-cols-3'>
        <div className='w-72 md:w-full '>
          <div className='bg-gray-200 p-4'>
            <div className='bg-gray-200 m-auto'><img src='./assets/man.png' alt='sadfjsdl' className='w-full object-cover '/></div>
          </div>

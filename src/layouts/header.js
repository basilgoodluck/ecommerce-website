    ...
    return (
        <div className='text-white border-b border-gray-200 pb-3 '>
          <div className='bg-black'>
            <div className='bg-black w-11/12 m-auto py-2 lg:w-4/5 lg:m-auto lg:p-3 lg:flex lg:justify-between lg:items-center'>
              <p className='text-sm lg:text-center lg:w-full lg:text-base'>Summer Sale For All Swim Suits And Free Express Delivery - OFF 50%! <a href='./' className='font-bold px-3'>ShopNow</a></p>
          ...
          <div className='w-full bg-white text-black pt-16 pb-3'>
            <div className='w-11/12 m-auto lg:w-4/5 lg:m-auto flex justify-between items-center'>
              <h1 className='font-bold text-2xl lg:text-3xl'>Ecommerce App</h1>

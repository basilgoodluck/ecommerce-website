    ...
    <div className=' w-11/12 md:w-4/5 m-auto mt-[50px] mb-[50px] flex flex-col gap-11 border-b pb-24 border-gray-400'>
        <div className='flex flex-col gap-3'>
            <div className='flex gap-7 items-center'>
                ...
                <h1 className='font-semibold text-md text-red-600'>Categories</h1>
            </div>
            <div className='flex gap-11 items-center justify-between'>
                <h1 className='text-black text-4xl font-medium'>Browse By Category</h1>
        ...
        <div className='flex gap-11 items-center overflow-x-hidden '>
            <div className='w-48 h-48 hover:bg-red-600 hover:border-red-600 hover:text-white cursor-pointer transition-all  border border-gray-400 rounded-md p-6 flex items-center justify-center flex-col gap-4' style={{flex: '0 0 auto'}}>

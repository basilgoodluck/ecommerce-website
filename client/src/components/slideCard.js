    ...
    <div className='w-full flex items-center justify-between gap-4 p-2' style={{flex: '0 0 100%'}}>
        <div className='w-full flex flex-col gap-4 items-start justify-center'>
            <div className='flex gap-4 items-center'>
                ...
                <p className='text-sm' style={{whiteSpace:'nowrap'}}>iPhone 14 Series</p>
            </div>
            <h1 className='text-xl md:text-2xl font-bold'>Up to 10% off Voucher</h1>
        ...
        <div className='h-full w-full'>
            <img className='object-cover' src={contentImg}  alt='iphoneImage' />
        </div>
    </div>    
  )
}
